(ns tictactoe.game
	(:require [tictactoe.player :refer :all]
			  ...
			  [tictactoe.game_rules :refer [get-winner winning-row-present? game-over-with-tie? valid-move?]]))
...
(defn set-up-new-game []
	(let [board (make-board 9 nil) player-list [(tictactoe.player.Human. "x") (tictactoe.player.UltimateComputer. "o")]]
